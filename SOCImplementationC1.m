...
%load('NPV.mat')
%load('NPVtraj.mat'); %load('OILTraj1.mat'); load('OILTraj2.mat'); load('OILTraj3.mat'); load('OILTraj4.mat')
%load('po1.mat'); load('po2.mat'); load('po3.mat'); load('po4.mat'); 
%load('pw1.mat'); load('pw2.mat'); load('pw3.mat'); load('pw4.mat')
%load('U1traj.mat'); load('U2traj.mat'); load('U3traj.mat'); load('U4traj.mat')
%load('uc1.mat'); load('uc2.mat'); load('uc3.mat'); load('uc4.mat')
%load('uw1.mat'); load('uw2.mat'); load('uw3.mat'); load('uw4.mat')
%load('Winjtraj1.mat'); load('Winjtraj2.mat'); load('Winjtraj3.mat'); load('Winjtraj4.mat')
%load('Wprotraj1.mat'); load('Wprotraj2.mat'); load('Wprotraj3.mat'); load('Wprotraj4.mat') 
%load('Theta_values.mat'); load('rSol') %load regression parameters
%load('rSol')
...
%u1 = 0.88/day;           % initial points using BM/OC
%u2 = 0.88/day;
%u3 = 0.88/day;
%u4 = 0.88/day;
...
po9socC1 = []; po10socC1 = []; po11socC1 = []; po12socC1 = [];
po13socC1 = []; po14socC1 = []; po15socC1 = []; po16socC1 = [];
pw9socC1 = []; Yw1 = []; pw10socC1 = []; pw11socC1 = []; pw12socC1 = [];
pw13socC1 = []; pw14socC1 = []; pw15socC1 = []; pw16socC1 = [];

usoc1C1 = []; usoc2C1 = []; usoc3C1 = []; usoc4C1 = [];
usoc5C1 = []; usoc6C1 = []; usoc7C1 = []; usoc8C1 = []; NPV1=0; NPVsocC1=[]; l = 0;
...
while t < T,
   ...
   W(1).val = u1; W(2).val = u2;  W(3).val = u3;  W(4).val = u4;
   W(5).val = u5; W(6).val = u6;  W(7).val = u7;  W(8).val = u8;
   W(9).val = -u1; W(10).val = -u2; W(11).val = -u3;  W(12).val = -u4;
   W(13).val = -u5; W(14).val = -u6; W(15).val = -u7;  W(16).val = -u8;
...
ucv8 = -(Theta(72))^-1*(Theta(64)*po9socC1(l)+Theta(65)*pw9socC1(l)+Theta(66)*po9socC1(l-1)+Theta(67)*pw9socC1(l-1)+Theta(68)*po9socC1(l-2)+Theta(69)*pw9socC1(l-2)+ Theta(70)*po16socC1(l-3)+Theta(71)*pw16socC1(l-3));   
   ...
   gradient1 = Theta(1)*po16socC1(l)+Theta(2)*pw16socC1(l)+Theta(3)*po16socC1(l-1)+Theta(4)*pw16socC1(l-1)+Theta(5)*po16socC1(l-2)+Theta(6)*pw16socC1(l-2)+ Theta(7)*po16socC1(l-2)+Theta(8)*pw16socC1(l-2)+ Theta(9)*ucv1
...
po9socC1 = po9socC1*24*60*60;
    po10socC1 = po10socC1*24*60*60;
    po11socC1 = po11socC1*24*60*60;
      po12socC1 = po12socC1*24*60*60;
        po13socC1 = po13socC1*24*60*60;
          po14socC1 = po14socC1*24*60*60;
            po15socC1 = po15socC1*24*60*60;
              po16socC1 = po16socC1*24*60*60;
              
              
pw9socC1 = pw9socC1*24*60*60;
pw10socC1 = pw10socC1*24*60*60;
pw11socC1 = pw11socC1*24*60*60;
pw12socC1 = pw12socC1*24*60*60;
pw13socC1 = pw13socC1*24*60*60;
pw14socC1 = pw14socC1*24*60*60;
pw15socC1 = pw15socC1*24*60*60;
pw16socC1 = pw16socC1*24*60*60;


usoc1C1 = usoc1C1*24*60*60;
usoc2C1 = usoc2C1*24*60*60;
usoc3C1 = usoc3C1*24*60*60;
usoc4C1 = usoc4C1*24*60*60;
usoc5C1 = usoc5C1*24*60*60;
usoc6C1 = usoc6C1*24*60*60;
usoc7C1 = usoc7C1*24*60*60;
usoc8C1 = usoc8C1*24*60*60;
